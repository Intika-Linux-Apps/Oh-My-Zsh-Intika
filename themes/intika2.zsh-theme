...
LEFTINFOS="$FG[059][%T] [%D %*] [%~]%{$reset_color%}"

PROMPT='
$LEFTINFOS
%{$fg[gray]%}[%n@%m%{$reset_color%}:$FG[069]%c%{$reset_color%}%{$fg[gray]%}$(git_prompt_info)]$(prompt_char)%{$reset_color%} '

# %W instead of %D for us
#RPROMPT='$FG[059][%D %*]%(?,$FG[022][R-$?],$FG[130][R-$?])$FG[024][!%!]%{$reset_color%}'
RPROMPT='%(?,,$FG[130][$?])$FG[059][%*]%(?,$FG[022][R-$?],)$FG[024][!%!]%{$reset_color%}'
